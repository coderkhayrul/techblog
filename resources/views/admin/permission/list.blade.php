        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @permission(['Permissions Add', 'All'])
                        <a class="btn btn-sm btn-primary pull-right"href="{{ route('permission.create') }}">Create Permission</a>
                    @endpermission
                </div>
                <div class="card-body">
          ...
          <table id="bootstrap-data-table" class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @permission(['Permissions Update', 'All'])
                            <a class="btn btn-sm btn-primary" href="{{ route('permission.edit',$data->id) }}">Edit</a>
                        @endpermission
                        @permission(['Permissions Delete', 'All'])
                            {!! Form::open(['route' => ['permission.destroy', $data->id],'style' => 'display:inline']) !!}
