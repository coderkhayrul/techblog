            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-sm btn-primary pull-right"href="{{ route('permission.index') }}">Back</a>
                    </div>
                    <div class="card-body">
                        <!-- Credit Card -->
                        <div id="pay-invoice">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('roles[]',$roles, null, ['class' => 'form-control mb-1 myselect','data-placeholder' => 'Select Rples', 'multiple']) !!}
                                </div>
