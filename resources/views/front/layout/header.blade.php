    ...
    <div class="container">
        <div class="header-section">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="logo">
                        <a href="{{ url('/') }}"><img style="width:85px"
                                src="{{ asset('upload/others/'.$share_data['front_logo']) }}" alt="Tech NewsLogo"></a>
                    </div>
                    <!-- Logo Section -->
                </div>
                <div class="col-md-4">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="#navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav">
                            ...
                            @foreach ($share_data['categories'] as $category)
                            <li><a href="{{ url('category').'/'.$category->id }}">{{ $category->name }}</a></li>
                            @endforeach
                            @foreach ($share_data['authors'] as $author)
